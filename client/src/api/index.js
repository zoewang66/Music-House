...
// artists
export const fetchArtists = (page = 1, name = "", limit = 9) =>
  api.get("/artist", { params: { page, name, limit } }).then((res) => res.data);
...
// songs
export const fetchSongs = (page = 1, opts = {}) =>
  api.get("/song", { params: { page, ...opts } });

    ...
    return (
      <Center
        style={{
          ...
          height: "100vh",
          zIndex: 9999,
          background: "rgba(255,255,255,0.75)", // optional overlay
        }}
      >
        <Loader size="xl" color="#346d67" /> {/* pick your color */}
      </Center>
    );
  }
    ...
    <PageContainer center={true}>
      ...
      <Center mt="xxxl">
        <Group position="center" spacing="md" mt="md">
          ...
          >
            {blocked
              ? <Loader size="xs" color="#346d67" />  // only on double-click
              : "Prev"
            }
          </Button>
          <Text>
          ...
          <Button
            ...
            onClick={() => loadPage(page + 1)}
          >
            {loading ? <Loader size={30} color="#346d67" /> : "Next"}
          </Button>
        </Group>
      </Center>
    </PageContainer>
